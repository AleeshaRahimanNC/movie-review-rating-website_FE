...
// import IMG1 from '@assets/background_img.jpeg'

// function CustomCarousal({ topRatedMovies }) {
//   return (
//     <>
      ...
      <div className="carousel-inner">
        {topRatedMovies.map((movie, index) => (
          <div key={movie._id} className={`carousel-item ${index === 0 ? "active" : ""}`}>
            <img src={movie.moviePic} className="d-block w-100" alt={movie.title} />
            <div className="carousel-caption d-md-block">
              <h5>{movie.title}</h5>
              <p>Rating: {movie.aggregatedRating}</p>
            </div>
          </div>
        ))}
      </div>
