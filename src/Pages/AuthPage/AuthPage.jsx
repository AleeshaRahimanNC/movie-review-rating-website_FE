...
function AuthPage() {
  ...
  return (
    <div className="background" >
      ...
      <div className="container-fluid d-flex justify-content-center  align-items-center  vh-100 vw-100 authpage" style={{position:"relative",zIndex:"2"}}>
        <div className="row">
          
          <div
          className={`col-md-6  ${boxType === "login" ? "left-image__login" : "left-image__register"}`}
           
            style={{ backgroundImage: `url(${authImage})`, backgroundColor:"rgba(0, 0, 0, 0.6)" }}
          >
            <div className="logo__wrapper">
            <h2 className="logo">
            <em>
              <img className="mystic-icon" src={ICON} alt="MysticMovies Icon" />
              MysticMovies
            </em>
          </h2>
            </div>
